...
class CMDTestCase(unittest.TestCase):
    ...
    def test_parseCommandOutput(self):
        with allure.step("When command execution works"):
            ...
            self.sClient.sc._jsc.sc.return_value.getExecutorMemoryStatus.return_value= countInstances
            ...
            countInstances.size.assert_called_once()
    ...
    def test_restCommandExec(self, mock_post):
        with allure.step("When REST command execution works"):
            ...
            ret = restCommandExec(self.sClient, "/bin/bash", base64.b64encode(b"echo test"), "spark://127::1", 2)
        ...
        with allure.step("When provided an invalid JAR url"):
            ...
            ret = restCommandExec(self.sClient, "/bin/bash", base64.b64encode(b"echo test"), "weird command", 2)
